...
import { useDispatch, useSelector } from 'react-redux'; // useDispatch is used to dispatch actions, and useSelector is used to extract data from the Redux store
  ...
  return (
    ...
    <div className="shopping-cart">
      ...
      <ul className="cart-items">
        {cartItems.map(item => (
           <li key={item.id} className='cart-name'>
